...
import { canWrite, useAsync, type NodeKind, type Space } from '../lib';
import { hrefHome, hrefSpace, navigate } from '../router';
import { PageTree, type NewNodeTarget } from './PageTree';
...
export function SpaceNavigation({
  ...
  expandPath: string[];
  /** Passed straight to the tree: it says when the fetched levels are stale. */
  refreshToken: number;
